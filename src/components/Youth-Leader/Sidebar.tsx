...
const navItems = [
  ...
  { label: "My Volunteers", href: "/youth-leader/volunteers", icon: Users },
  { label: "Tasks", href: "/youth-leader/tasks", icon: CheckSquare, badge: 2 },
  { label: "Activities", href: "/youth-leader/activities", icon: Calendar },
  { label: "Reports", href: "/youth-leader/reports", icon: FileText, badge: 1 },
  { label: "Training", href: "/youth-leader/training", icon: GraduationCap },
  { label: "Certificates", href: "/youth-leader/certificates", icon: Award, badge: 4 },
  { label: "Notifications", href: "/youth-leader/notifications", icon: Bell, badge: 3 },
];

const accountItems = [
  { label: "Profile", href: "/youth-leader/profile", icon: User },
