...
const initialProfile: UserProfile = {
  ...
  avatar: "ZA",
  avatarUrl: "",
  bio: "Passionate youth leader with 2+ years of experience in community engagement and volunteer management. Dedicated to empowering young people and creating positive social impact.",
